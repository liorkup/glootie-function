...
exports.googleAdsConversionResult = functions.https.onCall(async (data) => {
    ...
    return result['attributed'] && (({ ad_group_id, campaign_id }) => ({ ad_group_id, campaign_id }))(result['ad_events'][0]) 
        || { ad_group_id :undefined , campaign_id : undefined };
...
exports.test = functions.https.onCall((data) => {
    ...
    return result['attributed'] &&
     (({ ad_group_id, campaign_id }) => ({ ad_group_id, campaign_id }))(result['ad_events'][0]) || { ad_group_id :undefined , campaign_id : undefined };
